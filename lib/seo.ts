// Central place for site-wide SEO constants, so metadata, JSON-LD, and the
// sitemap all stay in sync instead of hardcoding the URL/name in five files.
//
// NOTE: update SITE_URL if the production domain changes.
export const SITE_URL = "https://koicard.app";
