export const FAQS = [
  ...
  },
  {
    ...
    a: "Yes. KoiCard can also decode QR codes containing vCard or MECARD data, so cards with a QR code on them are read directly without needing AI extraction.",
  },
  {
  ...
  },
  {
    ...
    a: "Your contacts and card scans are tied to your account only. KoiCard doesn't sell your data, use it for advertising, or train AI models on it. See the Privacy Policy for details.",
  },
  {
    q: "How much does KoiCard cost?",
    a: "KoiCard is free for 20 scans a month. An Event Pass ($5.99, valid 4 days) or a Monthly plan ($7.99/month) unlocks unlimited scanning for heavier use, like a multi-day conference.",
  },
  {
